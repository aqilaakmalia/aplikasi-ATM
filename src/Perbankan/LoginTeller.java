...
public class LoginTeller extends FrameDasar {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Login Via Teller");
    ...
    private void btnMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMasukActionPerformed
        if (txtNoRek.getText().equals("") || txtPin.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Anda gagal login via Teller");
        } else {
            noRek = txtNoRek.getText();
            pin = txtPin.getText();
            if (this.getTellerControll().validate(noRek, pin) ==  null) {
                JOptionPane.showMessageDialog(null, "Anda gagal login via Teller");
            } else {
                this.dispose();
                this.changeFrame(new FrameTeller(this.getAtmControll().validate(noRek, pin)));
                JOptionPane.showMessageDialog(null, "Anda berhasil login via Teller");
            }
        }
